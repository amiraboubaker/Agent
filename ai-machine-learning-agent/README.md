# AI and Machine Learning Agent

This is a full-stack AI and machine learning assistant with a React + TypeScript interface and a FastAPI backend. It classifies requests across architecture, RAG, prompt engineering, evaluation, security, and implementation, persists conversations in SQLite, and sends prompts to a configurable OpenAI-compatible chat-completions API.

Analysis guidance is displayed as Markdown with syntax highlighting and can be copied. The application never executes generated code automatically and never claims numerical results or trained models without execution.

## Structure

- `frontend/`: Vite React client
- `backend/app/`: FastAPI routes, AI task classifier, LLM adapter, SQLite persistence
...
The agent response contract uses these headings: `AI Objective`, `Recommended Architecture`, `Models`, `Data Flow`, `Tools`, `Implementation`, `Evaluation`, `Cost and Performance`, `Risks`, and `Improvements`.
