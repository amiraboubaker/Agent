# Insight: Data Science Agent

Insight is a full-stack data science assistant with a React + TypeScript interface and a FastAPI backend. It classifies requests as data quality, exploratory analysis, visualization, statistics, or modeling, persists conversations in SQLite, and sends prompts to a configurable OpenAI-compatible chat-completions API.
