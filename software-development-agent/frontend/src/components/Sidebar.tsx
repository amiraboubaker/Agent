import { Clock3, Plus, TerminalSquare } from "lucide-react";
import type { Conversation } from "../types";

export function Sidebar({ conversations, onNew }: { conversations: Conversation[]; onNew: () => void }) {
    return <aside className="sidebar">
        <div className="brand"><span className="brand-mark"><TerminalSquare size={19} /></span><span>forge<span className="brand-dot">.</span></span></div>
