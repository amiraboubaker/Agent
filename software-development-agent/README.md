# Forge: Software Development Agent

Forge is a full-stack development assistant with a React + TypeScript interface and a FastAPI backend. It classifies requests as coding, debugging, architecture, testing, refactoring, or documentation, persists conversations in SQLite, and sends prompts to a configurable OpenAI-compatible chat-completions API.

Generated code is displayed as Markdown with syntax highlighting and can be copied, but the application never executes generated code automatically.
