# Webcraft: Web Development Agent

Webcraft is a full-stack web development assistant with a React + TypeScript interface and a FastAPI backend. It classifies requests across requirements, architecture, UI, frontend, backend, database, testing, and deployment, persists conversations in SQLite, and sends prompts to a configurable OpenAI-compatible chat-completions API.
